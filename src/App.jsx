...
function App() {
  ...
  useEffect(() => {
    ...
    fetch(Url)
      ...
      .then((data) =>{
       //caso não existam caracteres que coincidam com a busca, é exibida uma mensagem indicando que não existem caracteres
        if(data.error){
  ...
  const reqApi=async() =>{
   //Fazendo uma requisição para a API do Rick and Morty
